...
import { FolderTree, Layers, Copy, Check, Terminal, Cpu, ArrowRight, ArrowDown } from "lucide-react";
              ...
              <code>
                {ecosystemContent.split("\n").map((line, i) => {
                  ...
                  if (line.includes("├── Spring ") || line.includes("└── Spring ")) {
                    ...
                    return (
                      <div key={i} className="py-1 flex flex-col sm:flex-row sm:items-baseline sm:justify-between gap-1 border-t border-[#D4AF37]/10 pt-2.5 mt-2">
              ...
              <code>
                {folderContent.split("\n").map((line, i) => {
                  if (line.includes("#")) {
                    ...
                    return (
                      <div key={i} className="py-1 border-b border-[#D4AF37]/5 last:border-b-0">
                  ...
                  return (
                    <div key={i} className="py-1 text-[#D4AF37] font-bold whitespace-pre">
                      {line}
                    </div>
                  );
                })}
